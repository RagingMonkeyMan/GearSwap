...
function user_job_setup()
	...
	state.Weapons:options('Normal','Savage','AccSavage','MagicWeapons','Evisceration','Throwing','SwordThrowing','Bow','ProcDagger','ProcStaff','ProcClub','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana')
	...
	send_command('bind ^y gs c weapons Default;gs c set WeaponSkillMode match') --Requips weapons and gear.
...
function init_gear_sets()
	...
	AdhemarDEX = { name=AdhemarDEX, bag="Wardrobe 2", augments={'DEX+12','AGI+12','Accuracy+20',}}
	AdhemarAGI = { name=AdhemarDEX, bag="Wardrobe", augments={'AGI+12','Rng.Acc.+20','Rng.Atk.+20',}}
	...
	sets.TreasureHunter = {head="White rarab cap +1", hands="Plunderer's Armlets +1", waist="Chaac Belt", feet="Skulker's Poulaines +1"}
    sets.ExtraRegen = {}
	...
	sets.weapons.ProcClub = {main="Shellbuster"}
    ...
    sets.precast.WS = {ammo="Cath Palug stone",
        ...
        body="Adhemar jacket +1",hands={ name=AdhemarDEX, bag="Wardrobe 2"},ring1="Ilabrat Ring",ring2="Gere Ring",
    ...
    sets.precast.WS['Aeolian Edge'] = {ammo="Seething bomblet +1",
        head=HercHelmMABWSD,neck="Sanctity Necklace",ear1="Friomisi earring",ear2="Moonshade Earring",
        body=HercBodyQuad,hands=HercGlovesMABWS,ring1="Dingir Ring",ring2="Epaminondas's ring",
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
        ...
        body="Malignance Tabard",hands="Turms mittens +1",ring1="Defending Ring",ring2="Gere Ring",
        back="Moonbeam Cape",waist="Flume Belt",legs="Samnuha tights",feet="Turms leggings +1"}
    ...
    sets.engaged = {ammo="Aurgelmir Orb +1",
        ...
        body="Adhemar Jacket +1",hands=AdhemarDEX,ring1="Gere Ring",ring2="Epona's Ring",
        back="Sacro Mantle",waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=HercBootsSTRTA}
    ...
    sets.engaged.FullAcc = {ammo="C. Palug Stone",
        ...
        body="Mummu Jacket +2",hands=AdhemarDEX,ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
        back="Sacro Mantle",waist="Olseni Belt",feet="Malignance Boots"}
    ...
    sets.engaged.DT = {ammo="Aurgelmir Orb +1",
        ...
        back="Sacro Mantle",waist="Flume belt",legs="Samnuha Tights",feet="Malignance Boots"}
