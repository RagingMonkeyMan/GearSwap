...
function user_job_setup()
	...
	state.Weapons:options('None','Daybreak','DualWeapons','MeleeWeapons')

	gear.obi_cure_waist = "Austerity Belt +1"
	gear.obi_cure_back = AlaunusFC
...
function init_gear_sets()
    ...
    --------------------------------------
	ChironicGlovesFC = { name="Chironic Gloves", augments={'Accuracy+21','Magic dmg. taken -3%','"Fast Cast"+5','Accuracy+16 Attack+16','Mag. Acc.+2 "Mag.Atk.Bns."+2',}}
	
	AlaunusFC = { name=AlaunusFC, augments={'CHR+20','Mag. Acc+20 /Mag. Dmg.+20','CHR+10','"Fast Cast"+10','Damage taken-5%',}}

	-- Weapons sets
	sets.weapons.MeleeWeapons = {main="Izcalli",sub="Ammurapi Shield"}
	sets.weapons.DualWeapons = {main="Izcalli",sub="Nehushtan"}
	sets.weapons.Daybreak = {main="Daybreak",sub=""}
    ...
    sets.precast.FC = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap",ammo="Incantor Stone",
		head="Vanya Hood",neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
		body="Inyanga Jubbah +2",hands=ChironicGlovesFC,ring1="Kishar Ring",ring2="Lebeche Ring",
		back=AlaunusFC,waist="Witful Belt",legs="Lengo Pants",feet="Regal Pumps +1"}

    sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {waist="Siegel Sash"})
	
    sets.precast.FC.Stoneskin = set_combine(sets.precast.FC['Enhancing Magic'], {})

    sets.precast.FC['Healing Magic'] = set_combine(sets.precast.FC, {legs="Ebers Pant. +1", feet="Vanya clogs", ear1="Nourish. Earring +1"})
    ...
    sets.precast.Waltz = {
		head="Vanya Hood",ear1="Roundel Earring",
	...
	sets.ConserveMP = {main=gear.grioavolr_fc_staff,sub="Umbra Strap",ammo="Hasty Pinion +1",
		head="Vanya Hood",neck="Cleric's torque +2",ear1="Gifted Earring",ear2="Gwati Earring",
	...
	sets.midcast.Cure = {main="Queller Rod",sub="Sors Shield",ammo="Pemphredo Tathlum",
		head="Kaykaus Mitra +1",neck="Cleric's torque +2",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		body="Theo. Briault +2",hands="Theophany Mitts +3",ring1="Ephedra Ring",ring2="Defending Ring",
		back=AlaunusFC,waist="Luminary Sash",legs="Ebers Pant. +1",feet="Kaykaus Boots +1"}
		
	sets.midcast.CureSolace = {main="Queller Rod",sub="Sors Shield",ammo="Pemphredo Tathlum",
		head="Kaykaus Mitra +1",neck="Cleric's torque +2",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		body="Ebers Bliaud +1",hands="Theophany Mitts +3",ring1="Ephedra Ring",ring2="Defending Ring",
		back=AlaunusFC,waist="Luminary Sash",legs="Ebers Pant. +1",feet="Kaykaus Boots +1"}

	sets.midcast.LightWeatherCure = {main="Chatoyant Staff",sub="Curatio Grip",ammo="Esper Stone +1",
		head="Kaykaus Mitra +1",neck="Cleric's torque +2",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		body="Kaykaus Bliaut",hands="Theophany Mitts +3",ring1="Ephedra Ring",ring2="Lebeche Ring",
	...
	sets.midcast.LightWeatherCureSolace = {main="Chatoyant Staff",sub="Curatio Grip",ammo="Esper Stone +1",
		head="Kaykaus Mitra +1",neck="Cleric's torque +2",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		body="Ebers Bliaud +1",hands="Theophany Mitts +3",ring1="Ephedra Ring",ring2="Lebeche Ring",
		back=AlaunusFC,waist="Hachirin-no-Obi",legs="Ebers Pant. +1",feet="Kaykaus Boots +1"}
	...
	sets.midcast.Cure.DT = {main="Queller Rod",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		...
		back=AlaunusFC,waist="Luminary Sash",legs="Ebers Pant. +1",feet="Gende. Galosh. +1"}
		
	--Melee Curesets are used whenever your Weapons state is set to anything but None.
	sets.midcast.MeleeCure = {ammo="Pemphredo Tathlum",
		head="Kaykaus Mitra +1",neck="Cleric's torque +2",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		body="Theo. Briault +2",hands="Kaykaus Cuffs",ring1="Ephedra Ring",ring2="Lebeche Ring",
		back=AlaunusFC,waist="Luminary Sash",legs="Ebers Pant. +1",feet="Kaykaus Boots +1"}
	...
	sets.midcast.Cursna = {main=gear.grioavolr_fc_staff,sub="Clemency Grip",ammo="Hasty Pinion +1",
		...
		body="Ebers Bliaud +1",hands="Fanatic Gloves",ring1="Haoma's Ring",ring2="Defending Ring",
		back=AlaunusFC,waist="Witful Belt",legs="Th. Pant. +3",feet="Vanya Clogs"}
	...
	sets.midcast.StatusRemoval = {main=gear.grioavolr_fc_staff,sub="Clemency Grip",ammo="Hasty Pinion +1",
		...
		back=AlaunusFC,waist="Witful Belt",legs="Ebers Pant. +1",feet="Regal Pumps +1"}
	...
	sets.midcast['Enhancing Magic'] = {main=gear.gada_enhancing_club,sub="Ammurapi Shield",ammo="Hasty Pinion +1",
		head="Telchine Cap",neck="Cleric's torque +2",ear1="Andoaa Earring",ear2="Gifted Earring",
	...
	sets.midcast.BarElement = {main="Beneficus",sub="Ammurapi Shield",ammo="Hasty Pinion +1",
		head="Ebers Cap +1",neck="Cleric's torque +2",ear1="Andoaa Earring",ear2="Gifted Earring",
		body="Ebers Bliaud +1",hands="Ebers Mitts +1",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back=AlaunusFC,waist="Olympus Sash",legs="Piety Pantaln. +1",feet="Ebers Duckbills +1"}

	sets.midcast.Impact = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head=empty,neck="Erra Pendant",ear1="Nourish. Earring +1",ear2="Digni. Earring",
	...
	sets.midcast['Elemental Magic'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Dosis Tathlum",
		head="C. Palug Crown",neck="Baetyl Pendant",ear1="Nourish. Earring +1",ear2="Friomisi Earring",
	...
	sets.midcast['Elemental Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Dosis Tathlum",
		head="C. Palug Crown",neck="Sanctity Necklace",ear1="Nourish. Earring +1",ear2="Crematio Earring",
	...
	sets.midcast['Divine Magic'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head="C. Palug Crown",neck="Cleric's torque +2",ear1="Nourish. Earring +1",ear2="Digni. Earring",
	...
	sets.midcast['Dark Magic'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head="Befouled Crown",neck="Erra Pendant",ear1="Nourish. Earring +1",ear2="Digni. Earring",
    ...
    sets.midcast.Drain = {main="Rubicundity",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head="Pixie Hairpin +1",neck="Erra Pendant",ear1="Nourish. Earring +1",ear2="Digni. Earring",
	...
	sets.midcast.Stun.Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head="Vanya Hood",neck="Erra Pendant",ear1="Nourish. Earring +1",ear2="Digni. Earring",
		body="Inyanga Jubbah +2",hands="Fanatic Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Aurist's Cape +1",waist="Acuity Belt +1",legs="Chironic Hose",feet=gear.chironic_nuke_feet}
	...
	sets.midcast.MndEnfeebles = set_combine(sets.midcast['Enfeebling Magic'], {back=AlaunusFC})
	sets.midcast.MndEnfeebles.Resistant = set_combine(sets.midcast['Enfeebling Magic'].Resistant, {back=AlaunusFC})
	...
	sets.defense.MDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		head="Kaykaus Mitra +1",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Sanare Earring",
	...
	sets.HPDown = {head="Pixie Hairpin +1",ear1="Mendicant's Earring",ear2="Evans Earring",
		...
		back=AlaunusFC,waist="Flax Sash",legs="Shedir Seraweels",feet=""}
	...
	sets.HPCure = {main="Queller Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		back=AlaunusFC,waist="Eschan Stone",legs="Ebers Pant. +1",feet="Kaykaus Boots +1"}
