function user_job_setup()
	...
	state.Weapons:options('None','Sacro','Naegling','DualWeapons','DualWeaponsAcc','DualEvisceration','DualClubs','DualAeolian','DualProcDaggers','EnspellOnly')
	...
	CapeSavage = { name="Sucellos's Cape", augments={'MND+20','Accuracy+20 Attack+20','MND+10','Weapon skill damage +10%',}}
	CapeFC = { name="Sucellos's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10',}}
...
function init_gear_sets()
	...
	sets.precast.FC = {
		head="Carmine mask +1",neck="Voltsurge Torque",ear1="Loquacious Earring",ear2="Malignance Earring",
		body="Viti. Tabard +3",hands="Gendewitha Gages",ring1="Kishar Ring",ring2="Prolix Ring",
		back=CapeFC,waist="Witful Belt",legs="Chironic hose",feet="Carmine greaves +1"}
	...
	sets.precast.WS.Proc = 	{range=empty,ammo="Hasty Pinion +1",
		...
		back=CapeSavage,waist="Olseni Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.precast.WS['Requiescat'] = {range=empty,ammo="Regal Gem",
		...
		back=CapeSavage,waist="Fotia Belt",legs="Jhakri Slops +2",feet="Jhakri Pigaches +2"}
	...
	sets.precast.WS['Chant Du Cygne'] = {range=empty,ammo="Voluspa Tathlum",
		...
		back=CapeSavage,waist="Fotia Belt",legs="Carmine Cuisses +1",feet="Thereoid Greaves"}
	...
	sets.precast.WS['Savage Blade'] = {range=empty,ammo="Regal Gem",
		...
		back=CapeSavage,waist="Sailfi Belt +1",legs="Jhakri Slops +2",feet="Jhakri Pigaches +2"}
	...
	sets.precast.WS['Sanguine Blade'] = {range=empty,ammo="Pemphredo Tathlum",
		...
		body=gear.merlinic_nuke_body,hands="Jhakri Cuffs +2",ring1="Stikini Ring",ring2="Archon Ring",
	...
	sets.precast.WS['Aeolian Edge'] = {range=empty,ammo="Pemphredo Tathlum",
		head=gear.merlinic_nuke_head,neck="Sanctity Necklace",ear1="Regal Earring",ear2="Malignance Earring",
		body=gear.merlinic_nuke_body,hands="Jhakri Cuffs +2",ring1="Stikini Ring",ring2="Freke Ring",
		back=gear.nuke_jse_back,waist="Refoccilation Stone",legs="Merlinic Shalwar",feet=gear.merlinic_nuke_feet}
    ...
    sets.midcast.Cure = {main="Daybreak",sub="Sors Shield",range=empty,ammo="Hasty Pinion +1",
        head="Vanya hood",neck="Colossus's Torque",ear1="Mendicant's Earring",ear2="Malignance earring",
	...
	sets.midcast['Enfeebling Magic'] = {main="Daybreak",sub="Ammurapi Shield",range=empty,ammo="Regal Gem",
		...
		back=CapeFC,waist="Luminary Sash",legs="Chironic Hose",feet="Vitiation Boots +3"}
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        ...
        body=gear.merlinic_nuke_body,hands="Amalric Gages +1",ring1="Stikini Ring",ring2="Freke Ring",
	...
	sets.midcast['Elemental Magic'].HighTierNuke = set_combine(sets.midcast['Elemental Magic'], {ammo="Pemphredo Tathlum",ear1="Regal Earring",ring1="Stikini Ring"})
	sets.midcast['Elemental Magic'].HighTierNuke.Resistant = set_combine(sets.midcast['Elemental Magic'].Resistant, {ear1="Regal Earring",ring1="Stikini Ring"})
	sets.midcast['Elemental Magic'].HighTierNuke.Fodder = set_combine(sets.midcast['Elemental Magic'].Fodder, {ammo="Pemphredo Tathlum",ear1="Regal Earring",ring1="Stikini Ring"})
	...
	sets.midcast.Stun.Resistant = {main="Daybreak",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		head="Atrophy Chapeau +3",neck="Dls. Torque +2",ear1="Regal Earring",ear2="Malignance Earring",
		body="Atrophy Tabard +3",hands="Volte Gloves",ring1="Stikini Ring",ring2="Stikini Ring",
	...
	-- Weapons sets
	sets.weapons.Sacro = {main="Naegling",sub="Sacro Bulwark"}
	...
	sets.weapons.DualWeaponsAcc = {main="Naegling",sub="Blurred Knife +1"}
	sets.weapons.DualEvisceration = {main="Tauret",sub="Blurred Knife +1"}
	sets.weapons.DualAeolian = {main="Malevolence",sub="Malevolence"}
	sets.weapons.DualProcDaggers = {main="Tauret",sub="Blurred Knife +1"}
	...
	sets.weapons.DualBlackHalo = {main="Kaja Rod",sub="Tauret"}
...
--		back=gear.stp_jse_back,waist="Windbuffet Belt +1",legs="Carmine Cuisses +1",feet="Carmine Greaves +1"}
	...
	sets.engaged.EnspellOnly = {
		head="Carmine Mask +1",neck="Dls. Torque +2",ear1="Suppanomimi",ear2="Digni. Earring",
		body="Ayanmo Corazza +2",hands="Aya. Manopolas +2",ring1="Stikini Ring",ring2="Chirich Ring",
		back="CapeSavage",waist="Windbuffet Belt +1",legs="Carmine Cuisses +1",feet="Carmine Greaves +1"}
