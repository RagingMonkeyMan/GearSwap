...
function init_gear_sets()
	...
	sets.precast.WS = {ammo="Ginsen",
		head="Adhemar Bonnet",neck="Fotia Gorget",ear1="Brutal Earring",ear2="Sherida Earring",
		body="Ken. Samue",hands="Adhemar Wristbands",ring1="Niqmaddu Ring",ring2="Regal Ring",
	...
	sets.precast.WS["Ascetic's Fury"]  = set_combine(sets.precast.WS, {head="Adhemar Bonnet"})
	sets.precast.WS["Victory Smite"]   = set_combine(sets.precast.WS, {ear1="Moonshade Earring",body="Abnoba Kaftan",hands="Ryuo Tekko",ring2="Begrudging Ring",legs="Mummu Kecks +1",feet="Mummu Gamash. +1"})
	...
	sets.precast.WS["Ascetic's Fury"].SomeAcc = set_combine(sets.precast.WS["Ascetic's Fury"], sets.precast.WSSomeAcc, {head="Mummu Bonnet +1",neck="Rancor Collar"})
	sets.precast.WS["Victory Smite"].SomeAcc = set_combine(sets.precast.WS["Victory Smite"], sets.precast.WSSomeAcc, {ear1="Moonshade Earring",body="Abnoba Kaftan",hands="Ryuo Tekko",ring2="Begrudging Ring",legs="Mummu Kecks +1",feet="Mummu Gamash. +1"})
	...
	sets.precast.WS["Ascetic's Fury"].Acc = set_combine(sets.precast.WS["Ascetic's Fury"], sets.precast.WSAcc, {head="Mummu Bonnet +1",neck="Rancor Collar"})
	sets.precast.WS["Victory Smite"].Acc = set_combine(sets.precast.WS["Victory Smite"], sets.precast.WSAcc, {head="Mummu Bonnet +1",ear1="Moonshade Earring",body="Ken. Samue",hands="Ryuo Tekko",ring2="Begrudging Ring",legs="Mummu Kecks +1",feet="Mummu Gamash. +1"})
	...
	sets.precast.WS["Ascetic's Fury"].FullAcc = set_combine(sets.precast.WS["Ascetic's Fury"], sets.precast.WSFullAcc, {head="Mummu Bonnet +1",neck="Rancor Collar"})
	...
	sets.precast.WS["Ascetic's Fury"].Fodder = set_combine(sets.precast.WS["Ascetic's Fury"], sets.precast.WSFodder, {head="Adhemar Bonnet",neck="Rancor Collar",back="Buquwik Cape",waist="Grunfeld Rope"})
	...
	sets.defense.MDT = {ammo="Staunch Tathlum",
		...
		back="Moonbeam Cape",waist="Flax Sash",legs=gear.herculean_dt_legs,feet="Hippo. Socks +1"}
	...
	sets.engaged = {ammo="Ginsen",
		...
		body="Ken. Samue",hands="Adhemar Wristbands",ring1="Niqmaddu Ring",ring2="Epona's Ring",
	...
	sets.engaged.PDTOnly = {ammo="Ginsen",
		...
		body="Emet Harness +1",hands="Adhemar Wristbands",ring1="Niqmaddu Ring",ring2="Patricius Ring",
