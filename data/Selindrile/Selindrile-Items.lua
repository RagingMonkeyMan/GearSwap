...
gear.merlinic_physpact_hands = {name="Merlinic Dastanas",augments={'Pet: Accuracy+27 Pet: Rng. Acc.+27','Blood Pact Dmg.+10','Pet: STR+1',}}
...
gear.odyssean_wsd_hands = {name="Odyssean Gauntlets",augments={'Accuracy+26','Weapon skill damage +3%','Attack+9',}}
