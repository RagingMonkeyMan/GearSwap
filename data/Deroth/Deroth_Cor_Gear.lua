...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {main="Rostam", ranged="Compensator", 
								head="Lanun tricorne", 
								neck="Regal necklace",
								hands="Chasseur's gants", ring2="Barataria ring",
    ...
    sets.precast.CorsairShot = {ammo=gear.QDbullet,
        head="Nyame Helm",neck="Sibyl Scarf",ear1="Friomisi Earring",ear2="Hecate's Earring",
        body="Nyame Mail",hands="Carmine Finger Gauntlets +1",ring1="Arvina ringlet +1",ring2="Dingir Ring",
	...
	sets.precast.CorsairShot.Damage = {ammo=gear.QDbullet,
        head="Nyame Helm",neck="Sibyl Scarf",ear1="Friomisi Earring",ear2="Hecate's Earring",
        body="Nyame Mail",hands="Carmine Finger Gauntlets +1",ring1="Arvina ringlet +1",ring2="Dingir Ring",
        back=CamulusMABWS,waist="Eschan stone",legs="Nyame Flanchard",feet="Chass. Bottes +1"} --Nyame Sollerets
    ...
    sets.precast.CorsairShot['Light Shot'] = {ammo=gear.QDbullet,
        head="Malignance chapeau",neck="Sibyl Scarf",ear1="Friomisi Earring",ear2="Gwati earring",
        body="Nyame Mail",hands="Carmine Finger Gauntlets +1",ring1="Arvina ringlet +1",ring2="Dingir Ring",
    ...
    sets.precast.WS = {
        ...
        back=CamulusRATTWS,waist="Fotia belt",legs=HercPantsRAWS,feet="Ikenga's Clogs"}
    ...
    sets.precast.WS.Acc = {
        ...
        back=CamulusRATTWS,waist=gear.ElementalBelt,legs="Meghanada chausses +2",feet="Ikenga's Clogs"}		
    ...
    sets.precast.WS['Last Stand'] = {ammo=gear.WSbullet,
        ...
        body="Ikenga's Vest",hands="Meghanada gloves +2",ring1="Epaminondas's Ring",ring2="Dingir Ring",
        back=CamulusRATTWS,waist="Fotia belt",legs="Ikenga's trousers",feet="Ikenga's Clogs"}
    ...
    sets.precast.WS['Last Stand'].Acc = {ammo=gear.WSbullet,
        ...
        back=CamulusRATTWS,waist="Kwahu kachina belt +1",legs="Meghanada chausses +2",feet="Ikenga's Clogs"}
    ...
    sets.precast.WS['Leaden Salute'] = {ammo=gear.MAbullet,
        ...
        body="Nyame Mail",hands="Carmine Fin. Ga. +1",ring1="Archon Ring",ring2="Dingir Ring",
        back=CamulusMABWS,waist="Eschan stone",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    sets.precast.WS['Aeolian Edge'] = {ammo="Animikii Bullet", -- gear.MAbullet after DP
        ...
        body="Nyame Mail",hands="Carmine finger gauntlets +1",ring1="Epaminondas's Ring",ring2="Dingir Ring",
        back=CamulusMABWS,waist="Eschan stone",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    sets.midcast.RA = {ammo=gear.RAbullet,
        head="Ikenga's hat",neck="Iskur gorget",ear1="Telos Earring",ear2="Dedition earring",
        body="Ikenga's Vest",hands="Malignance gloves",ring1="Crepuscular Ring",ring2="Dingir Ring",
    ...
    sets.idle = {ammo=gear.RAbullet,
        ...
        body="Nyame mail",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Dingir Ring",
        back=CamulusDW,waist="Flume belt +1",legs="Nyame flanchard",feet="Nyame sollerets"}
		
    sets.idle.PDT = {ammo=gear.RAbullet,
        head="Nyame helm",neck="Loricate Torque +1",ear1="Eabani Earring",ear2="Odnowa Earring +1",
        body="Nyame mail",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Dingir Ring",
        back=CamulusDW,waist="Flume belt",legs="Nyame flanchard",feet="Nyame sollerets"}
...
function job_self_command(commandArgs, eventArgs)
	...
	elseif commandArgs[1]:lower() == 'ddweapons' then
		send_command('gs c weapons None;gs c update')
		equip({main=empty,sub=empty})
		send_command('gs c weapons DualSavageWeapons;gs c update;aws use savage blade')
				add_to_chat(158,'Savage weapon set equiped')
	elseif commandArgs[1]:lower() == 'magicweapons' then
		equip({main=empty,sub=empty})
		send_command('gs c weapons DualLeadenMelee;gs c update;aws use leaden salute')
				add_to_chat(158,'Magic weapon sets equiped')
	elseif commandArgs[1]:lower() == 'rangedweapons' then
		send_command('gs c weapons Ranged;gs c update;aws use last stand')
