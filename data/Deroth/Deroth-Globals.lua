...
send_command('bind ^tab gs c weapons Default') --Requips weapons and gear.
...
send_command('bind ^t gs c cycle treasuremode') --Toggles hitting things with your treasure hunter set.
