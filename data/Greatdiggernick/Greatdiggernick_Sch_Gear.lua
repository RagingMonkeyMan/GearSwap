...
function init_gear_sets()
	...
	sets.midcast['Enfeebling Magic'] = {main="Bunzi's Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head=empty,neck="Argute Stole +2",ear1="Crep. Earring",ear2="Malignance Earring",
    ...
    sets.midcast['Elemental Magic'] = {
		...
		right_ring="Shiva Ring +1", -- Metamorph +1
    	back=AMBUNUKE
	}
	...
	sets.midcast.Impact = {main="Bunzi's Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head=empty,neck="Argute Stole +2",ear1="Regal Earring",ear2="Malignance Earring",
		body="Twilight Cloak",hands="Agwu's Gages",ring1="Metamor. Ring +1",ring2="Stikini Ring",
		back=AMBUNUKE,waist="Sacro cord",legs="Agwu's Slops",feet="Arbatel Loafers +3"}
    ...
    sets.idle = {
		...
		body="Arbatel Gown +3",
		hands="Nyame gauntlets", -- DM AUG
		legs="Nyame flanchard",--{ name="Chironic Hose", augments={'"Fast Cast"+5','Damage taken-1%','"Refresh"+2','Accuracy+19 Attack+19',}}, -- DM AUG
    ...
    sets.idle.PDT = {
		...
		sub="Ammurapi Shield", --"Genmei Shield",
		ammo="Staunch Tathlum +1", -- Homilary
		head="Nyame helm",--{ name="Chironic Hat", augments={'INT+8','STR+4','"Refresh"+2',}}, -- DM AUG OR BEFOULED CROWN
		body="Arbatel Gown +3",
		hands="Nyame gauntlets", -- DM AUG
		legs="Nyame flanchard",--{ name="Chironic Hose", augments={'"Fast Cast"+5','Damage taken-1%','"Refresh"+2','Accuracy+19 Attack+19',}}, -- DM AUG
		feet={ name="Nyame Sollerets", augments={'Path: B',}},
    ...
    -- Normal melee group
    sets.engaged = {main="Malignance Pole", sub="Khonsu",ammo="Staunch Tathlum",
	...
	sets.engaged.PDT = {main="Malignance Pole", sub="Khonsu",ammo="Staunch Tathlum",
        head="Nyame Helm",neck="Unmoving Collar +1",ear1="Tuisto Earring",ear2="Odnowa Earring +1",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Gelatinous Ring +1",ring2="Eihwaz Ring",
        back="Moonlight Cape",waist="Carrier's Sash",legs="Nyame Flanchard",feet={ name="Nyame Sollerets", augments={'Path: B',}}}
